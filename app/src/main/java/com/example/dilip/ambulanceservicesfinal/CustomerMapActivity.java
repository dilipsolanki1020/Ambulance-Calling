...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mrequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mMap.addMarker(new MarkerOptions().position(accidentlocation).title("Accident occured here"));
    ...
    private  void getClosestAmbulance(){
        ...
        GeoQuery geoQuery = geofire.queryAtLocation(new GeoLocation(accidentlocation.latitude, accidentlocation.longitude),radius);
        ...
        driverlocationref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    mdrivermarker = mMap.addMarker(new MarkerOptions().position(driverlatlng).title("Your Ambulance...").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher1)));
                }
            }
