...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,com.google.android.gms.location.LocationListener,RoutingListener {
    ...
    private Button mlogout,settings,rideComplete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rideComplete = (Button) findViewById(R.id.done);
    ...
    private  void getaccidentpickuplocation(){
        ...
        DatabaseReference  assigncustomerpickuplocationref = FirebaseDatabase.getInstance().getReference().child("customerrequest").child(customer_id).child("1");
        assigncustomerpickuplocationrefListener = assigncustomerpickuplocationref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickuplatlng).title("Accident Location..").icon(BitmapDescriptorFactory.fromResource(R.mipmap.acc)));
    ...
    private  void endride(){
        ...
        DatabaseReference driverRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers").child(userId).child("patientdropped");
        driverRef.removeValue();

        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("patientdropped");
